...
const InfoRow: React.FC<{ label: string; value: React.ReactNode; subLabel: string }> = ({
  label,
  value,
  subLabel,
}) => (
  ...
  return (
    <div className="grid grid-cols-3 gap-1">
      <div className="col-span-1 grid grid-cols-2 grid-rows-2 gap-1">
        ...
        <FunctionButton
          label="F3"
          subLabel="Delivery 送餐"
          isActive={orderType === OrderType.Delivery}
          onClick={handleDeliveryClick}
        />
        <FunctionButton
          label="F4"
          subLabel="Collect 领取"
          isActive={orderType === OrderType.Collection}
      ...
      <div className="col-span-3 grid grid-cols-2 gap-2 mt-1">
        <div className="bg-gray-300 border-2 border-t-gray-600 border-l-gray-600 border-b-gray-100 border-r-gray-100 p-1">
          <InfoRow label="Time" value={customerInfo.deliveryTime || "--:--"} subLabel="时间" />
        </div>
        <div className="bg-gray-300 border-2 border-t-gray-600 border-l-gray-600 border-b-gray-100 border-r-gray-100 p-1">
          <InfoRow
            label="Dist"
