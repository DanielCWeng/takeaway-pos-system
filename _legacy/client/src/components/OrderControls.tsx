...
const TextButton = ({
  ...
  <button
    className={`h-full w-full bg-gray-300 border-2 border-r-gray-500 border-b-gray-500 border-l-gray-100 border-t-gray-100 active:border-l-gray-500 active:border-t-gray-500 active:border-r-gray-100 active:border-b-gray-100 flex flex-col items-center justify-center disabled:text-gray-400 disabled:cursor-not-allowed ${className}`}
    {...props}
  >
