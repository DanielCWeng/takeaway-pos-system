                        ...
                        {selectedOrder.data.orderType === "delivery" && (
                          <div className="space-y-2 col-span-2">
                            ...
                            <p className="text-sm font-bold text-zinc-400 leading-relaxed max-w-[80%]">
                              {selectedOrder.data.customerInfo?.line1}
                              {selectedOrder.data.customerInfo?.line2 && (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-zinc-300">
                        This will permanently delete the customer profile and anonymize all linked
                        order history.
                      </p>
                      <p className="text-xs font-mono text-zinc-500">
                        {deleteCustomerDialog.phone}
                      </p>
                    </div>
                  </div>
