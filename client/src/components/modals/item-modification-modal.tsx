...
export function ItemModificationModal({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="modal-keyboard-aware fixed inset-0 z-50 flex items-center justify-center bg-background/90 backdrop-blur-sm p-4"
    >
      <motion.div
      ...
      >
        <div className="flex items-center justify-between border-b border-border/60 px-6 py-4">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="font-display text-xl font-bold tracking-tight">{originalName}</span>
          </div>
