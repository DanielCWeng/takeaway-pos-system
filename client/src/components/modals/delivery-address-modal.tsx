...
export function DeliveryAddressModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const { customer } = await apiClient.verifyAddress(
        formData.phone || "0000",
        addressData,
      );
        ...
        <div className="flex-1 flex flex-col md:flex-row min-h-0">
              ...
              <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        value={
                          formData.phone?.startsWith("UNKNOWN-")
                            ? ""
                            : formData.phone
                        }
                        onChange={(e) =>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        onKeyDown={(e) =>
                          e.key === "Enter" && handlePostcodeLookup()
                        }
                        placeholder="NG9 1AA"
                      ...
                      <Button
                        variant="default"
                        size="icon"
                        className="h-14 w-14 shrink-0 shadow-lg shadow-primary/20"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={formData.town}
                      onChange={(e) =>
                        setFormData((p) => ({ ...p, town: e.target.value }))
                      }
                      className="h-14 text-lg font-semibold bg-background/50"
                    />
                  </div>
                ...
                <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-border/40">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground flex items-center gap-2">
                      <MessageSquare className="h-3 w-3" /> Delivery
                      Instructions
                    </label>
                    <textarea
          ...
          <div className="w-full md:w-80 bg-muted/10 p-6 flex flex-col gap-6">
            ...
            <div className="mt-auto space-y-3">
              ...
              <Button
                className="w-full h-16 text-xl font-black shadow-xl shadow-primary/20 gap-3"
                onClick={handleSave}
                disabled={isLoading}
              >
