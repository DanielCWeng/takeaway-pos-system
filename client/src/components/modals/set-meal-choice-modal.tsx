        ...
        <div className="flex items-center justify-between border-b border-border/60 px-6 py-4 bg-muted/20">
          <div>
            <h2 className="text-lg font-bold text-foreground">
              {choice.description || "Make a Selection"}
            </h2>
        ...
        <div className="p-6">
          ...
          {requiredCount > 1 && (
            <div className="mb-6 rounded-2xl bg-muted/20 border border-border/40 p-4">
              <h3 className="text-[10px] uppercase tracking-wider text-muted-foreground mb-3 font-semibold">
                Your Selections
              </h3>
              <div className="flex flex-wrap gap-2 min-h-[40px]">
                {Array.from({ length: requiredCount }).map((_, i) => (
                  ...
                  >
                    <span className="text-xs font-medium">{selections[i] || "Empty Slot"}</span>
                    {selections[i] && (
